...
public class MatchDetailsActivity extends AppCompatActivity {
    ...
    private void Initialization() {
        ...
        tvMatchDetailsStatus=findViewById(R.id.match_details_status);
        tvMatchStatus=findViewById(R.id.match_details_live_match_status);
        tvTeamAStatus=findViewById(R.id.my_match_details_team_a);
        tvTeamBStatus=findViewById(R.id.my_match_details_team_b);
        tvMatchNameA=findViewById(R.id.my_match_team_a);
        tvMatchNameB=findViewById(R.id.my_match_team_b);
...
//        scoredBoardModels=new ArrayList<>();
      RequestQueue rq = Volley.newRequestQueue(MatchDetailsActivity.this);
...
//                            comingSoonRecyclerView.setAdapter(ha);
            ...
            public void onErrorResponse(VolleyError error) {
                ...
                Toast.makeText(MatchDetailsActivity.this, "Error "+error.getMessage(), Toast.LENGTH_SHORT).show();
            }
        });
